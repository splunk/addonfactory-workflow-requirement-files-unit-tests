...
def check_transport_params(filename):
    ...
    if root is None:
        ...
        return
    transport_type_list = ["dbx", "modinput","Modinput", "Mod input","Modular Input", "Modular input", "modular input","modular_input", "Mod Input", "windows_input", "hec_event", "forwarder", "file_monitor", "scripted_input","scripted input","hec_raw" ]
    event_no = 1
